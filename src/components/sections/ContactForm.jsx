...
const ACCESS_KEY = "f64eb834-cff5-488f-84ac-8724dcadb08c";
    ...
    >
      <div className="mx-auto px-4 md:px-0" style={{ width: "min(calc(82vw + 3rem), 100%)" }}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-32 pt-10 md:pt-20">
          ...
          <div className="flex flex-col justify-start">
            ...
            <motion.div className="flex flex-col gap-4 md:gap-6" variants={fadeInUp}>
              <div className="flex items-center gap-3 md:gap-4 text-neutral-900 group cursor-pointer">
                ...
                <div>
                  <p className="text-[0.65rem] md:text-xs text-neutral-400 uppercase tracking-widest font-bold mb-0.5 md:mb-1">Email</p>
              ...
              <div className="flex items-center gap-3 md:gap-4 text-neutral-900 group cursor-pointer">
                ...
                <div>
                  <p className="text-[0.65rem] md:text-xs text-neutral-400 uppercase tracking-widest font-bold mb-0.5 md:mb-1">Téléphone</p>
          ...
          <motion.form ref={formRef} onSubmit={handleSubmit} className="flex flex-col gap-6 md:gap-8" variants={fadeInUp}>
            <input type="hidden" name="access_key" value={ACCESS_KEY} />
            <input type="hidden" name="subject" value="Nouveau message — Lemen's Prod" />
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              <div className="flex flex-col gap-2">
                <label className="text-[0.65rem] md:text-xs text-neutral-500 uppercase tracking-widest font-bold">Nom</label>
                <input
                  type="text"
                  name="from_name"
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[0.65rem] md:text-xs text-neutral-500 uppercase tracking-widest font-bold">Entreprise</label>
                <input
                  type="text"
                  name="company"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              <div className="flex flex-col gap-2">
                <label className="text-[0.65rem] md:text-xs text-neutral-500 uppercase tracking-widest font-bold">Email</label>
                <input
                  type="email"
                  name="reply_to"
              ...
              <div className="flex flex-col gap-2">
                ...
                <select name="type_projet" className="bg-transparent border-b border-neutral-300 py-3 md:py-4 text-neutral-900 focus:border-black focus:outline-none transition-colors duration-300 appearance-none cursor-pointer text-base">
                  <option className="bg-white text-neutral-500">Sélectionnez un sujet</option>
                  ...
                  <option className="bg-white text-neutral-900">Production Visuelle</option>
                  <option className="bg-white text-neutral-900">Autre question</option>
                </select>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              <div className="flex flex-col gap-2">
                ...
                <select name="budget" className="bg-transparent border-b border-neutral-300 py-3 md:py-4 text-neutral-900 focus:border-black focus:outline-none transition-colors duration-300 appearance-none cursor-pointer text-base">
              ...
              <div className="flex flex-col gap-2">
                ...
                <select name="deadline" className="bg-transparent border-b border-neutral-300 py-3 md:py-4 text-neutral-900 focus:border-black focus:outline-none transition-colors duration-300 appearance-none cursor-pointer text-base">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[0.65rem] md:text-xs text-neutral-500 uppercase tracking-widest font-bold">Message</label>
              <textarea
                name="message"
                rows="4"
            ...
            <div className="flex flex-col items-stretch md:items-end gap-3 mt-2 md:mt-4">
              <button
                ...
                className="group relative px-6 md:px-8 py-3 md:py-4 bg-neutral-900 overflow-hidden rounded-xl md:rounded-2xl text-white w-full md:w-fit shadow-lg hover:shadow-xl transition-shadow disabled:opacity-60"
              >
                ...
                <span className="relative z-10 flex items-center justify-center gap-2 md:gap-3 font-bold uppercase tracking-widest text-[0.65rem] md:text-xs">
                  {status === "sending" ? "Envoi en cours..." : "Obtenir ma stratégie visuelle"}
                  {status !== "sending" && (
              ...
              {status === "success" && (
                <p className="text-sm text-green-600 font-medium text-center md:text-right">
                  Message envoyé ! Nous vous répondrons sous 24h.
                </p>
              )}
              {status === "error" && (
                <p className="text-sm text-red-500 font-medium text-center md:text-right">
